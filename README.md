...
- `models/linear-coefficients-v1/model.json` is a language-independent linear model for the sample CSV, with explicit feature order, coefficients, intercept, and prediction formula.
